<main>
    @section('title')
        <title>Admin | লটারি সম্পাদনা</title>
    @endsection
            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">লটারি সম্পাদনা</li>
                    </ol>
                </nav>
            </div>
            <div class="ms-auto">
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h4 class="mb-0">লটারি সম্পাদনা করুন: {{ $lottery->name }}</h4>
                </div>
                ...
                <form wire:submit.prevent="update">
                    ...
                    <div class="d-flex justify-content-end gap-3 mt-4">
                        ...
                        <button type="submit" class="btn btn-primary">
                            <i class="bx bx-save"></i> লটারি আপডেট করুন
                        </button>
                    </div>
                </form>
            </div>
