<main>
    @section('title')
        <title>Admin | Withdrawal Request Management</title>
    @endsection
    @section('css')
          ...
          <div class="ps-3">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb mb-0 p-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">Withdrawal Request Management</li>
              </ol>
            </nav>
          </div>
        </div>
        ...
        @endif
          ...
          <div class="card">
            <div class="card-header py-3">
              <h6 class="mb-0">Withdrawal Request Management</h6>
            </div>
            <div class="card-body">
               <div class="row">
                @if ($setingsMode)
                   ...
                   <div class="card border shadow-none w-100">
                     <div class="card-body">
                         ...
                         <div class="col-12">
                           ...
                           <input class="form-control" type="text" wire:model="method">
                         </div>
                    ...
                    <div class="card-body">
                      <div class="table-responsive">
                         <table class="table align-middle">
                           ...
                           <tbody>
                            @if($withdrawalStatus && $withdrawalStatus->count())
                                @foreach($withdrawalStatus as $item)
                                    <tr>
